...
namespace asp_servicios.Controllers
{
    ...
    {
        private IImagenesAplicacion? iAplicacion = null;
        private TokenController? tokenController = null;

        public ImagenesController(IImagenesAplicacion? iAplicacion,
        ...
        public string Buscar()
        {
            ...
            try
            {
                ...
                var entidad = JsonConversor.ConvertirAObjeto<Imagenes>(
